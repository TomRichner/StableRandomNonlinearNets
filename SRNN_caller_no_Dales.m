...
[M, EI_vec] = generate_M_no_iso_noDales(n,w,sparsity, EI);
...
n_a_I = 3; % typically 0, number of SFA timescales for I neurons (typically 0)
n_b_E = 1; % typically 1 or 2, number of STD timescales for E neurons
n_b_I = 1; % typically 0, number of STD timescales for I neurons (typically 0)
