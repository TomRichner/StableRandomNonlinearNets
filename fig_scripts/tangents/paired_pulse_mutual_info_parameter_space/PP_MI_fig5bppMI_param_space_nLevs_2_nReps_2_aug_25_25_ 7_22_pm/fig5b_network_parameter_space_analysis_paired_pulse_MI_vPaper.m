...
%% Analysis Conditions to Compare (SFA only)
conditions = { ...
...
%% Analysis Parameters
n_levels = 2; % 5, Number of values to test for each parameter in the grid
n_repetitions = 2; % Number of repetitions (different seeds) per parameter combination
