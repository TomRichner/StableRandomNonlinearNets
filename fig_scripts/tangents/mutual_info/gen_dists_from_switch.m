...
sec_from_switch = 0.002; % seconds
samples_from_switch = fix(sec_from_switch*fs);
samples_per_switch = 1;
...
for i_epoch = 3:n_epochs % skip the first two because initial is 0.5
    ...
    mu_this_epoch = mu_t(mu_start_index(i_epoch-0)); % the stimulus level for the PREVIOUS epoch
