...
level_sequence = repmat([1 2 3],1,fix(n_time_chunks/3));
...
ylim([0 0.7])
save_some_figs_to_folder_2('/Users/richner.thomas/Desktop/local_code/SRNN/fig_scripts/tangents/mutual_info/figs_MI_delay_ordered',['MI_vs_delay_' sfa_std_both_none],3,{'fig','svg','png'})
