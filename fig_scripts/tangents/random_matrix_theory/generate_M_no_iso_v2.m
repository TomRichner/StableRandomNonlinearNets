function [A, EI_vec] = generate_M_no_iso_v2(n,w,sparsity, EI)
...
% v2 fixes self connectsion to not be constant but to have standard deviation w.selfE and w.selfI
    ...
    % Dale's law
    diag_idx                     = 1:n+1:n^2;
    A_diag = A(diag_idx); % save this before enforcing Dale's law?
