...
%% plotting parameters
sr_or_poisson = 'poisson'; % sr, poisson, or sr_stacked
include_sum_E_I_SR = true; % true or false
...
disp('Saving figures...');
save_folder = fullfile(fileparts(mfilename('fullpath')), 'v6_output_figs_raster');
save_name = ['example_raster_v6_tseries_seed' num2str(seed)];
