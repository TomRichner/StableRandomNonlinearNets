...
show_mean_adapt = true; % New parameter: true for mean SFA/STD, false for individual traces

%% Network
n = 10; % number of neurons

Lya_method = 'none'; % 'benettin', 'qr', 'svd', or 'none'
use_Jacobian = false;
...
if ~strcmpi(Lya_method, 'none') && ~isempty(fieldnames(lya_results))
    SRNN_tseries_figure_IED_adapt(t, u_ex, r, a_E_ts, a_I_ts, b_E_ts, b_I_ts, u_d_ts, params, T, Lya_method, sr_or_poisson, include_sum_E_I_SR, show_mean_adapt, lya_results);
else
    SRNN_tseries_figure_IED_adapt(t, u_ex, r, a_E_ts, a_I_ts, b_E_ts, b_I_ts, u_d_ts, params, T, Lya_method, sr_or_poisson, include_sum_E_I_SR, show_mean_adapt);
end
