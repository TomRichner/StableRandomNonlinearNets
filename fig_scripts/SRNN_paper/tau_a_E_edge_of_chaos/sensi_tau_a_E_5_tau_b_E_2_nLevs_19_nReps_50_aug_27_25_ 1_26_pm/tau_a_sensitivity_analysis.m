...
params_to_analyze = {'tau_a_E_2','tau_b_E_2'}; % Only analyze these parameters
% params_to_analyze = {}; % Empty means analyze all parameters

%% Analysis Parameters
n_levels = 19; % Number of values to test for each parameter
...
for c_idx = 1:length(conditions)
    ...
    p_default.tau_a_E_2 = 5;
    p_default.tau_b_E_2 = 2; % if n_b_E == 1, then this value is used.
    ...
    ranges.tau_a_E_2 = [5, 60];
    ranges.tau_b_E_2 = [5, 60];
    ...
    for i = 1:length(param_names)
        ...
        % for k = 1:total_runs
            ...
            try
                ...
                result = SRNN_caller_wrapped_for_sensitivity_dual_stage_rndWalk(...
                    sim_seed, ...
                    current_p.n, ...
                    current_p.EE_factor, ...
                    current_p.IE_factor, ...
